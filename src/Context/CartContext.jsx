...
export default function CartContext({ children }) {
  ...
  const [cartCount, setCartCount] = React.useState(quantityLocalStorage);
  const [totalToPay, setTotalToPay] = React.useState(priceLocalStorage);
  ...
  return (
    <>
      <cartContext.Provider value={{ addItem, getQuantity, cart, removeProduct, increaseCartCount, cartCount, clear, totalToPay }}>
        {children}
